...
class TitleDeedNatures {
	...
	*/
	...
	/**
	* private class variable title_deed_nature
	*/
	private $_title_deed_nature;
	
	/**
	* returns the value of title_deed_nature
	*/
	public function _get_title_deed_nature() {
		return $this->_title_deed_nature;
	}
	
	/**
	* sets the value of title_deed_nature
	*/
	public function set_title_deed_nature($title_deed_nature) {
		$this->_title_deed_nature = title_deed_nature;
	}
	...
	*/
	...
	/**
	* Performs a database query and returns the value of id_title_deed_nature 
	* based on the value of $id_title_deed,$title_deed_nature,$posted_date passed to the function
	*/
	public function get_id_title_deed_nature($id_title_deed,$title_deed_nature,$posted_date) {
		$columns = array ('id_title_deed','title_deed_nature','posted_date');
		$records = array ($id_title_deed,$title_deed_nature,$posted_date);
		$id_title_deed_nature_ = $this->query_from_title_deed_natures ( $columns, $records );
		return count($id_title_deed_nature_)>0 ? $id_title_deed_nature_ [0] ['id_title_deed_nature'] : null;
	}
	
	
	/**
	* Performs a database query and returns the value of id_title_deed 
	* based on the value of $id_title_deed_nature passed to the function
	*/
	public function get_id_title_deed($id_title_deed_nature) {
		$columns = array ('id_title_deed_nature');
		$records = array ($id_title_deed_nature);
		$id_title_deed_ = $this->query_from_title_deed_natures ( $columns, $records );
		return count($id_title_deed_)>0 ? $id_title_deed_ [0] ['id_title_deed'] : null;
	}
	
	
	/**
	* Performs a database query and returns the value of title_deed_nature 
	* based on the value of $id_title_deed_nature passed to the function
	*/
	public function get_title_deed_nature($id_title_deed_nature) {
		$columns = array ('id_title_deed_nature');
		$records = array ($id_title_deed_nature);
		$title_deed_nature_ = $this->query_from_title_deed_natures ( $columns, $records );
		return count($title_deed_nature_)>0 ? $title_deed_nature_ [0] ['title_deed_nature'] : null;
	}
	...
	* based on the value of $id_title_deed_nature passed to the function
	*/
	public function get_posted_date($id_title_deed_nature) {
		$columns = array ('id_title_deed_nature');
		$records = array ($id_title_deed_nature);
		$posted_date_ = $this->query_from_title_deed_natures ( $columns, $records );
	...
	*/
	public function insert_prepared_records($id_title_deed,$title_deed_nature,$posted_date,$redundancy_check= false, $printSQL = false) {
		$columns = array('id_title_deed','title_deed_nature','posted_date');
		$records = array($id_title_deed,$title_deed_nature,$posted_date);
		return $this->insert_records_to_title_deed_natures ( $columns, $records,$redundancy_check, $printSQL );
	}
	...
	* @return Table Name [title_deed_natures] 
	*/
	public static function get_table() {
		return 'title_deed_natures';
	}
	...
	*/
	...
	/**
	* Used  to calculate the number of times a record exists in the table [title_deed_natures]
	*
	* @return the number of times a record exists exists in the table [title_deed_natures]
	*/
	...
	/**
	* Inserts data into the table[title_deed_natures]
	*
	* @return 1 if data was inserted,0 otherwise
	* if redundancy check is true, it inserts if the record if it never existed else.
	* if the record exists, it returns the number of times the record exists on the relation
	*/
	public function insert_records_to_title_deed_natures(Array $columns, Array $records,$redundancy_check = false, $printSQL = false) {
		return $this->insert_records ( $this->get_table (), $columns, $records,$redundancy_check, $printSQL );
	}
	
	/**
	* Deletes all the records that meets the passed criteria from the table [title_deed_natures]
	*  
	* @return number of deleted rows
	*/
	public function delete_record_from_title_deed_natures(Array $columns, Array $records, $printSQL = false) {
		return $this->delete_record ( $this->get_table (), $columns, $records, $printSQL );
	}
	
	/**
	* updates all the records that meets the passed criteria from the table [title_deed_natures]
	*  
	* @return number of updated rows
	*/
	public function update_record_in_title_deed_natures(Array $columns, Array $records, Array $where_columns, Array $where_records, $printSQL = false) {
		return $this->update_record ( $this->get_table (), $columns, $records, $where_columns, $where_records, $printSQL );
	}
	
	/**
	* Gets an Associative array of the records in the table [title_deed_natures] that meets the passed criteria
	*  
	* @return associative array of the records that are found after performing the query
	*/
	public function fetch_assoc_in_title_deed_natures($distinct, Array $columns, Array $records, $extraSQL="", $printSQL = false) {
	...
	* @return associative array of the records that are found after performing the query
	*/
	public function query_from_title_deed_natures(Array $columns, Array $records,$extraSQL="",  $printSQL = false) {
		return $this->query ( $this->get_table (), $columns, $records,$extraSQL,$printSQL );
	}
	
	/**
	* Gets an Associative array of the records in the table [title_deed_natures] that meets the passed distinct criteria
	*  
	* @return associative array of the records that are found after performing the query
	*/
	public function query_distinct_from_title_deed_natures(Array $columns, Array $records,$extraSQL="",  $printSQL = false) {
	...
	* @return associative array of the records that are found after performing the query
	*/
	public function search_in_title_deed_natures(Array $columns, Array $records,$extraSQL="", $printSQL = false) {
	...
	*/
	...
	/**
	* Gets an Associative array of the records in the table [title_deed_natures] that meets the distinct passed criteria
	*  
	* @return associative array of the records that are found after performing the query
	*/
