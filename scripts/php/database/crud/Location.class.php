...
class Location {
	...
	*/
	public function fetch_assoc_in_location(Array $columns, Array $records, $printSQL = false) {
	...
	* @return associative array of the records that are found after performing the query
	*/
	public function query_from_location(Array $columns, Array $records, $printSQL = false) {
	...
	* @return associative array of the records that are found after performing the query
	*/
	public function search_in_location(Array $columns, Array $records, $printSQL = false) {
