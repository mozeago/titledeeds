...
class District {
	...
	*/
	public function fetch_assoc_in_district($distinct, Array $columns, Array $records, $extraSQL="", $printSQL = false) {
	...
	* @return associative array of the records that are found after performing the query
	*/
	public function query_from_district(Array $columns, Array $records,$extraSQL="",  $printSQL = false) {
		return $this->query ( $this->get_table (), $columns, $records,$extraSQL,$printSQL );
	}
	
	/**
	* Gets an Associative array of the records in the table [district] that meets the passed distinct criteria
	*  
	* @return associative array of the records that are found after performing the query
	*/
	public function query_distinct_from_district(Array $columns, Array $records,$extraSQL="",  $printSQL = false) {
	...
	* @return associative array of the records that are found after performing the query
	*/
	public function search_in_district(Array $columns, Array $records,$extraSQL="", $printSQL = false) {
	...
	*/
	...
	/**
	* Gets an Associative array of the records in the table [district] that meets the distinct passed criteria
	*  
	* @return associative array of the records that are found after performing the query
	*/
