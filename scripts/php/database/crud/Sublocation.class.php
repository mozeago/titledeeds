...
class Sublocation {
	...
	/**
	* private class variable id_location
	*/
	private $_id_location;
	
	/**
	* returns the value of id_location
	*/
	public function _get_id_location() {
		return $this->_id_location;
	}
	
	/**
	* sets the value of id_location
	*/
	...
	*/
	...
	/**
	* private class variable sub_location_headquarters
	*/
	private $_sub_location_headquarters;
	
	/**
	* returns the value of sub_location_headquarters
	*/
	public function _get_sub_location_headquarters() {
		return $this->_sub_location_headquarters;
	}
	
	/**
	* sets the value of sub_location_headquarters
	*/
	public function set_sub_location_headquarters($sub_location_headquarters) {
		$this->_sub_location_headquarters = sub_location_headquarters;
	}
	...
	* based on the value of $id_location,$sublocation_name,$sub_location_headquarters,$trashed,$deleted,$first_created,$last_modified passed to the function
	*/
	public function get_id_sublocation($id_location,$sublocation_name,$sub_location_headquarters,$trashed,$deleted,$first_created,$last_modified) {
		...
		$id_sublocation_ = $this->query_from_sublocation ( $columns, $records );
		return count($id_sublocation_)>0 ? $id_sublocation_ [0] ['id_sublocation'] : null;
	}
	
	
	/**
	* Performs a database query and returns the value of id_location 
	* based on the value of $id_sublocation passed to the function
	*/
	public function get_id_location($id_sublocation) {
		$columns = array ('id_sublocation');
		$records = array ($id_sublocation);
		$id_location_ = $this->query_from_sublocation ( $columns, $records );
		return count($id_location_)>0 ? $id_location_ [0] ['id_location'] : null;
	}
	...
	*/
	public function get_sublocation_name($id_sublocation) {
		$columns = array ('id_sublocation');
		$records = array ($id_sublocation);
		$sublocation_name_ = $this->query_from_sublocation ( $columns, $records );
		return count($sublocation_name_)>0 ? $sublocation_name_ [0] ['sublocation_name'] : null;
	}
	
	
	/**
	* Performs a database query and returns the value of sub_location_headquarters 
	* based on the value of $id_sublocation passed to the function
	*/
	public function get_sub_location_headquarters($id_sublocation) {
		$columns = array ('id_sublocation');
		$records = array ($id_sublocation);
		$sub_location_headquarters_ = $this->query_from_sublocation ( $columns, $records );
		return count($sub_location_headquarters_)>0 ? $sub_location_headquarters_ [0] ['sub_location_headquarters'] : null;
	}
	...
	*/
	public function get_trashed($id_sublocation) {
		$columns = array ('id_sublocation');
		$records = array ($id_sublocation);
		$trashed_ = $this->query_from_sublocation ( $columns, $records );
	...
	*/
	public function get_deleted($id_sublocation) {
		$columns = array ('id_sublocation');
		$records = array ($id_sublocation);
		$deleted_ = $this->query_from_sublocation ( $columns, $records );
	...
	*/
	public function get_first_created($id_sublocation) {
		$columns = array ('id_sublocation');
		$records = array ($id_sublocation);
		$first_created_ = $this->query_from_sublocation ( $columns, $records );
	...
	*/
	public function get_last_modified($id_sublocation) {
		$columns = array ('id_sublocation');
		$records = array ($id_sublocation);
		$last_modified_ = $this->query_from_sublocation ( $columns, $records );
	...
	*/
	public function insert_prepared_records($id_location,$sublocation_name,$sub_location_headquarters,$trashed,$deleted,$first_created,$last_modified,$redundancy_check= false, $printSQL = false) {
		$columns = array('id_location','sublocation_name','sub_location_headquarters','trashed','deleted','first_created','last_modified');
		$records = array($id_location,$sublocation_name,$sub_location_headquarters,$trashed,$deleted,$first_created,$last_modified);
		return $this->insert_records_to_sublocation ( $columns, $records,$redundancy_check, $printSQL );
	}
	...
	*/
	...
	/**
	* Used  to calculate the number of times a record exists in the table [sublocation]
	*
	* @return the number of times a record exists exists in the table [sublocation]
	*/
	...
	/**
	* Inserts data into the table[sublocation]
	*
	* @return 1 if data was inserted,0 otherwise
	* if redundancy check is true, it inserts if the record if it never existed else.
	* if the record exists, it returns the number of times the record exists on the relation
	*/
	public function insert_records_to_sublocation(Array $columns, Array $records,$redundancy_check = false, $printSQL = false) {
		return $this->insert_records ( $this->get_table (), $columns, $records,$redundancy_check, $printSQL );
	}
	
	/**
	* Deletes all the records that meets the passed criteria from the table [sublocation]
	*  
	* @return number of deleted rows
	*/
	public function delete_record_from_sublocation(Array $columns, Array $records, $printSQL = false) {
		return $this->delete_record ( $this->get_table (), $columns, $records, $printSQL );
	}
	
	/**
	* updates all the records that meets the passed criteria from the table [sublocation]
	*  
	* @return number of updated rows
	*/
	public function update_record_in_sublocation(Array $columns, Array $records, Array $where_columns, Array $where_records, $printSQL = false) {
		return $this->update_record ( $this->get_table (), $columns, $records, $where_columns, $where_records, $printSQL );
	}
	
	/**
	* Gets an Associative array of the records in the table [sublocation] that meets the passed criteria
	*  
	* @return associative array of the records that are found after performing the query
	*/
	public function fetch_assoc_in_sublocation($distinct, Array $columns, Array $records, $extraSQL="", $printSQL = false) {
	...
	* @return associative array of the records that are found after performing the query
	*/
	public function query_from_sublocation(Array $columns, Array $records,$extraSQL="",  $printSQL = false) {
		return $this->query ( $this->get_table (), $columns, $records,$extraSQL,$printSQL );
	}
	
	/**
	* Gets an Associative array of the records in the table [sublocation] that meets the passed distinct criteria
	*  
	* @return associative array of the records that are found after performing the query
	*/
	public function query_distinct_from_sublocation(Array $columns, Array $records,$extraSQL="",  $printSQL = false) {
	...
	* @return associative array of the records that are found after performing the query
	*/
	public function search_in_sublocation(Array $columns, Array $records,$extraSQL="", $printSQL = false) {
	...
	*/
	...
	/**
	* Gets an Associative array of the records in the table [sublocation] that meets the distinct passed criteria
	*  
	* @return associative array of the records that are found after performing the query
	*/
